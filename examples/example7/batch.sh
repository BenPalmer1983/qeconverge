...
python /rds/homes/b/bxp912/apps/python/qeconverge.py input.in calc > result1.txt
python /rds/homes/b/bxp912/apps/python/qeconverge.py input.in plot > result1.txt
